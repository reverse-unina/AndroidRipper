...
import it.unina.android.ripper.planner.widget_inputs.RandomValuesGenerator;
...
public class SeekBarEventPlanner extends WidgetEventPlanner {
	 ...
	 */
	public SeekBarEventPlanner(WidgetDescription widgetDescription) {
	...
	protected TaskList tap(Task currentTask, ArrayList<Input> inputs, String... options)
	{
		...
		t.add(new Task(currentTask, mWidget, InteractionType.SET_BAR, inputs, RandomValuesGenerator.generate()));
		return t;
	}
