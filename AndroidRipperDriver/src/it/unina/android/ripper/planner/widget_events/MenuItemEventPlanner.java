...
/**
 * Planner for MENU_ITEM Widget
 * 
 * @author Nicola Amatucci - REvERSE
 * 
 */
public class MenuItemEventPlanner extends WidgetEventPlanner {
	...
	protected TaskList tap(Task currentTask, ArrayList<Input> inputs, String... options)
	{
		...
		t.add(new Task(currentTask, mWidget, InteractionType.CLICK_MENU_ITEM, inputs, this.mWidget.getValue()));
		return t;
	}
