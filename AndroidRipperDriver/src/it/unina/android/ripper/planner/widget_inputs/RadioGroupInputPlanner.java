...
/**
 * RadioGroup Widget Input Planner  
 *  
...
public class RadioGroupInputPlanner extends WidgetInputPlanner {
	...
	public RadioGroupInputPlanner(WidgetDescription widget, RandomValuesGenerator valuesGenerator) {
		super(widget, InteractionType.RADIO_SELECT, true);
	}
