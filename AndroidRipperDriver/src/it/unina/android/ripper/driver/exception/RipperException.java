 ...
 *
 */
public class RipperException extends Exception {

	private Class<?> sourceClass;
	private String method;
	private String ripperMessage;
	
	public RipperException(Class<?> sourceClass, String method, String message, Throwable cause) {
		super(message, cause);
	...
	public RipperException(Class<?> sourceClass, String method, String message) {
		super();
		this.sourceClass = sourceClass;
		this.method = method;
		this.ripperMessage = message;
