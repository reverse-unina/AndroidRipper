...
//	}
	...
	/* (non-Javadoc)
	 * @see it.unina.android.ripper.automation.IAutomation#setInput(int, int, java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	public void setInput(int widgetId, int widgetIndex, String widgetName, String widgetType, String interactionType, String value) {
		this.robot.updateWidgets();
		...
		if (widgetId > 0) {
			...
			v = this.robot.findWidgetByIndexOrEquivalenceOrId(widgetId, widgetIndex, widgetName, widgetType);
		}
