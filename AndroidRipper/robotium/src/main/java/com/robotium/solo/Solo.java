...
public class Solo {
	...
	public void clickLongOnView(View view) {
		clickLongOnView(view, false);
	}

	public void clickLongOnView(View view, boolean immediately) {
		if(config.commandLogging){
	...
	public void clickLongOnView(View view, int time) {
		clickLongOnView(view, time, false);

	}

	public void clickLongOnView(View view, int time, boolean immediately) {
		if(config.commandLogging){
